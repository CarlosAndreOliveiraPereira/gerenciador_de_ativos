...
define('MICROSOFT_TENANT_ID', 'SEU_TENANT_ID_AQUI'); // ou 'common' para multitenant
define('MICROSOFT_REDIRECT_URI', 'http://localhost/api/auth/microsoft_callback.php'); // URL de callback
?>